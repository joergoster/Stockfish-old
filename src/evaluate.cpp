...
namespace {
  ...
  {// A     B     C     D     E     F     G     H
    ...
    V(4), V(8),V(25),V(32),V(32),V(25), V(8), V(4),
    V(8),V(12),V(34),V(38),V(38),V(34),V(12), V(8),
    V(6), V(8),V(25),V(25),V(25),V(25), V(8), V(6) },
  {
    V(0), V(0), V(0), V(0), V(0), V(0), V(0), V(0), // Bishops
    V(0), V(0), V(0), V(0), V(0), V(0), V(0), V(0),
    V(0), V(2), V(7), V(7), V(7), V(7), V(2), V(0),
    V(2), V(8),V(14),V(16),V(16),V(14), V(8), V(2),
    V(3),V(10),V(21),V(25),V(25),V(21),V(10), V(3),
    V(2), V(6),V(11),V(14),V(14),V(11), V(6), V(2) }
  };

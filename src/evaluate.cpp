...
namespace {
  ...
  {// A     B     C     D     E     F     G     H
    ...
    V(5), V(4), V(1),V(11), V(7), V(5), V(1), V(0),
    V(2),V(12),V(17),V(25),V(28),V(15), V(8),V(10),
    V(3), V(8),V(26),V(36),V(40),V(22),V(13), V(6),
    V(6), V(0),V(22),V(15),V(18),V(19), V(3), V(5) },
  {
    V(0), V(0), V(0), V(0), V(0), V(0), V(0), V(0), // Bishops
    V(0), V(0), V(0), V(0), V(0), V(0), V(0), V(0),
    V(1), V(4), V(6), V(3), V(1), V(5), V(4), V(4),
    V(6),V(11),V(11), V(8),V(12),V(11), V(1), V(5),
    V(1),V(12),V(19),V(33),V(29),V(25),V(13), V(4),
    V(1), V(7),V(11),V(10), V(8),V(13), V(4), V(9) }
  };
  ...
  Score evaluate_pieces(const Position& pos, EvalInfo& ei, Score* mobility, Bitboard* mobilityArea) {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (Pt == BISHOP || Pt == KNIGHT)
        {
            ...
            if (Pt == BISHOP)
            {
                b = squares_of_color(s) & pos.pieces(Us, PAWN);
                if (b)

...
Value Eval::evaluate(const Position& pos) {
  ...
  // Scale and shift NNUE for compatibility with search
  // and classical evaluation.
  auto  adjusted_NNUE = [&]()
  {
     int scale =  32 * pos.count<PAWN>()
  ...
  Value v = (!Eval::useNNUE || pos.is_classical()) ? Evaluation<NO_TRACE>(pos).value()  // classical
                                                   : adjusted_NNUE();                   // NNUE

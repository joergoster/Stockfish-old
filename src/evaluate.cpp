...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    ...
    { S(-54,-50), S(-30,-23), S( 2, -3), S(24, 21), S(38, 33), S(56, 52), // Bishops
      S( 56, 54), S( 67, 59), S(73, 74), S(74, 65), S(72, 69), S(87, 73),
      S( 87, 77), S( 87, 78) },
    { S(-52,-64), S(-28,  1), S( 1,  3), S( 1, 14), S( 3, 23), S( 6, 59), // Rooks
      S( 12, 66), S( 21, 82), S(30, 88), S(32,110), S(30,110), S(31,113),
      S( 36,116), S( 34,128), S(44,128) },
    { S(-34,-41), S(-25,-23), S(-9, -7), S(-1,  3), S( 0,  9), S(10, 12), // Queens
      S(  6, 30), S( 26, 43), S(26, 28), S(26, 38), S(15, 38), S(26, 41),
      S( 21, 38), S( 20, 38), S(23, 43), S(30, 42), S(20, 40), S(20, 45),
      S( 16, 47), S( 34, 38), S(27, 43), S(33, 35), S(28, 37), S(20, 42),
      S( 34, 40), S( 31, 43), S(22, 40), S(25, 38) }
  };

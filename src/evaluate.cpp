...
namespace {
  ...
  {// A     B     C     D     E     F     G     H
    ...
    V(1), V(3), V(5), V(7), V(7), V(5), V(3), V(1),
    V(4),V(10),V(18),V(23),V(23),V(18),V(10), V(4),
    V(6),V(15),V(26),V(35),V(35),V(26),V(15), V(6),
    V(4),V(10),V(18),V(23),V(23),V(18),V(10), V(4) },
  {
    V(0), V(0), V(0), V(0), V(0), V(0), V(0), V(0), // Bishops
    V(0), V(0), V(0), V(0), V(0), V(0), V(0), V(0),
    V(0), V(1), V(1), V(2), V(2), V(1), V(1), V(0),
    V(2), V(4), V(9),V(12),V(12), V(9), V(4), V(2),
    V(3), V(9),V(17),V(25),V(25),V(17), V(9), V(3),
    V(2), V(4), V(9),V(12),V(12), V(9), V(4), V(2) }
  };

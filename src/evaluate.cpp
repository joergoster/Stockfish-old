...
#undef S
  ...
  void Evaluation<T>::initialize() {
    ...
    // Squares occupied by those pawns, by our king or queen, or controlled
    // by enemy pawns, are excluded from the mobility area.
  ...
  Score Evaluation<T>::pieces() {
    ...
    while ((s = *pl++) != SQ_NONE)
    {
        ...
        if (Pt == BISHOP || Pt == KNIGHT)
        {
            ...
            // Bonus for piece right behind a pawn
  ...
  Score Evaluation<T>::king() const {
    ...
    // Find the squares that opponent attacks in our king flank,
    // and the squares which are attacked twice in that flank.
  ...
  Score Evaluation<T>::threats() const {
    ...
    if (defended | weak)
    {
        ...
        // Overload bonus (non-pawn enemies attacked once or more)

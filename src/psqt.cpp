...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-152, -97), S(-103,-82), S(-86,-46), S(-79,-14) },
   { S( -89, -69), S( -43,-55), S(-21,-17), S(-10,  9) },
   { S( -77, -50), S( -22,-39), S(  0, -8), S(  9, 28) },
   { S( -31, -41), S(  18,-25), S( 43,  7), S( 47, 38) },
   { S( -32, -46), S(  16,-25), S( 38,  2), S( 50, 41) },
   { S( -17, -55), S(  37,-38), S( 56, -8), S( 81, 32) },
   { S( -68, -64), S( -17,-50), S(  5,-24), S( 14, 13) },
   { S(-206,-110), S( -72,-90), S(-47,-50), S(-33,-13) }
  },
  { // Bishop

...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-149, -97), S(-100,-82), S(-83,-46), S(-76,-14) },
   { S( -86, -69), S( -43,-55), S(-21,-17), S(-10,  9) },
   { S( -74, -50), S( -22,-39), S(  0, -8), S(  9, 28) },
   { S( -28, -41), S(  18,-25), S( 43,  7), S( 47, 38) },
   { S( -29, -46), S(  16,-25), S( 38,  2), S( 50, 41) },
   { S( -14, -55), S(  37,-38), S( 56, -8), S( 71, 27) },
   { S( -65, -64), S( -17,-50), S(  5,-24), S( 14, 13) },
   { S(-203,-110), S( -69,-90), S(-44,-50), S(-30,-13) }
  },
  { // Bishop

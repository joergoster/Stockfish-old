...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-20, 0), S(-14, 0), S(-10, 0), S(-2, 0) },
   { S(-18, 0), S(-12, 0), S( -8, 0), S( 0, 0) },
   { S(-16, 0), S(-10, 0), S( -6, 0), S( 2, 0) },
   { S(-14, 0), S( -8, 0), S( -4, 0), S( 4, 0) },
   { S(-12, 0), S( -6, 0), S( -2, 0), S( 6, 0) },
   { S(-10, 0), S( -4, 0), S(  0, 0), S( 8, 0) },
   { S( -2, 0), S(  4, 0), S(  8, 0), S(16, 0) },
   { S(-10, 0), S( -4, 0), S(  0, 0), S( 8, 0) }
  },
  { // Queen
